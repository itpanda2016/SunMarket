...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <p><input type="checkbox" name="name"  value="" checked="" />导出报表增加openid关联的营销员信息</p>
        <p><input type="checkbox" name="name"  value="" checked="checked" />导出报表增加用户昵称</p>
        ...
        <p><input type="checkbox" name="name" value="" checked="checked" />最后一行有合计显示，并提供导出excel功能。</p>
        <p>
